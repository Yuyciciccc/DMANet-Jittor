...
class FocalLoss(nn.Module):
    def execute(self, classifications, regressions, anchors, annotations):
        ...
        for b in range(batch_size):
            ...
            IoU_argmax , IoU_max = jt.argmax(IoU, dim=1)               # [A]
            ...
            pos_mask = IoU_max >= 0.5                       # [A]
            num_pos = pos_mask.sum()

            assigned = bbox_annotation[IoU_argmax]          # [A, 5]
            targets[pos_mask, :] = 0
            cls_idx = assigned[pos_mask, 4].int32()         # [P]
            targets[pos_mask, cls_idx] = 1
